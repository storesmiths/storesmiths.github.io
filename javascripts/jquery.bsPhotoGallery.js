(function($) {
  ...
  $.fn.bsPhotoGallery = function(options) {
      ...
      function showModal(){
          ...
          html += '<div style="height:40px;clear:both;display:block; padding-top:10px">';
          html += '<a class="controls btn btn-primary next pull-right" data-bsp-id="'+clicked.ulId+'" href="'+ (clicked.nextImg) + '">next &raquo;</a>';
          html += '<a class="controls btn btn-primary previous" data-bsp-id="'+clicked.ulId+'" href="' + (clicked.prevImg) + '">&laquo; prev</a>';
          html += '</div>';
